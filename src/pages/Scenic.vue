<template>
  <div class="scenic">
    ...
    <div class="swiper_banner">
      <swiper dots-position="center" auto loop :aspect-ratio="400/800" v-if="poiData.images?poiData.images.length:false">
...
<script>
  import {Swiper, SwiperItem, XProgress, XDialog, Checker, CheckerItem} from 'vux'
  ...
  export default {
    ...
    methods: {
      ...
      changePoi (id) {
        this.$router.push({path: '/scenic', query: {poiId: id}})
        this.poiId = id
        this.getPoidata()
        this.isParse = true
